...
export const salesChannels = pgTable("SalesChannel", {
  id: cuid(),
  name: text("name").notNull(),
  platform: text("platform").notNull(), // FACEBOOK | INSTAGRAM | GOOGLE | WHATSAPP | TIKTOK | SNAPCHAT
...
export const channelOrders = pgTable("ChannelOrder", {
  ...
  platform: text("platform").notNull(), // FACEBOOK | INSTAGRAM | WHATSAPP | TIKTOK | SNAPCHAT

/**
 * Snapchat Channel Details API
 *
 * GET    /api/channels/snapchat/[id]  — Get channel details + stats
 * PATCH  /api/channels/snapchat/[id]  — Update channel settings
 * DELETE /api/channels/snapchat/[id]  — Disconnect channel
 */
...
export async function PATCH(req: Request, ctx: RouteContext) {
  ...
  if (parsed.data.organizationId) updates.externalAccountId = parsed.data.organizationId;
  ...
  audit({
    ...
    resourceId: id,
    details: { platform: "SNAPCHAT", action: "update", changes: Object.keys(parsed.data) },
    success: true,
  });
...
export async function DELETE(_req: Request, ctx: RouteContext) {
  ...
  audit({
    ...
    resource: "SalesChannel",
    resourceId: id,
    details: { platform: "SNAPCHAT", name: channel.name },
    success: true,
  });
